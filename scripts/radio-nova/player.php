 ...
 * Gildecio E Barboza 
 * 2017 05 19
 * Change log: Corrigido evento - DB radio_locucao
*/
...
//verifica se base radio_locucao existe, cria se nao existir
if( empty(mysql_fetch_array(mysql_query("SHOW DATABASES LIKE 'radio_locucao'") ) ) )
{
  exec("mysqladmin -u root create radio_locucao");
  exec("mysql -u root radio_locucao < estrutura_radio_locucao");
}
